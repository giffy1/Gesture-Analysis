...
% sliding window approach and a Random Forest classifier and clustering 
% to detect sessions from gesture density using kernel density estimation
...
%work as is...?
    ...
    [~, colorSet] = plotSessionData(preprocessedTestData(:,1:4), sessionStart, sessionEnd, sessionLabels, NO_ACTIVITY_COLOR, AxesConstants.X, 'SameScale', 'Pre-processed Accelerometer Signal');
    hold on
